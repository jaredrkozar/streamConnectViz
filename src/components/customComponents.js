...
function CustomDatePicker(props) {
    return (
        ...
        <div className="relative h-96 overflow-auto">
            ...
            <Listbox.Button className="relative w-fit cursor-default rounded-lg bg-slate-100 dark:bg-slate-600 py-2 pl-3 pr-20 text-left focus:outline-none "><h1>{props.array[props.getterValue]}</h1></Listbox.Button>

...
<Tab.Group>
        <Tab.List className="transition-width ease flex space-x-1 pointer-events-none relative h-14 flex rounded-xl bg-[#000921] p-2 w-fit">
        {
          appList.map((tab) => (
            ...
            selected ? 'w-fit bg-blue-500' : "hover:bg-blue-500/75 hover:ease-out duration-500 w-12 pl-2")}
            >
